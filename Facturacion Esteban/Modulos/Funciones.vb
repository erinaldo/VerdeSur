Module Funciones
    ...
    Public Sub calcular_subtotal(ByVal precio As Double, ByVal cantidad As Double,
                                 ...
                                 ByRef p_impuestoTotal As String)

        Dim resultado As Double
        Dim _TotalImpuesto As Double = 0

        impuesto = impuesto / 100
        resultado = precio * cantidad
        _TotalImpuesto = impuesto * resultado
        subtotal = convertir_formato_miles_decimales(CStr(resultado))
        p_impuestoTotal = convertir_formato_miles_decimales(_TotalImpuesto)
